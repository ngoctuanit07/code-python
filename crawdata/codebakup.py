...
def crawl_product(link):
    ...
    product_description = soup.find('div', class_='woocommerce-Tabs-panel--description').text.strip()  # Thêm phần lấy mô tả
...
# Link sản phẩm
product_link = 'https://giadung1.giaodienwebmau.com/may-loc-khong-khi-va-tao-ionizer-ferroli-fap-60d/'
...
category_id = 68  # ID danh mục truyền vào
